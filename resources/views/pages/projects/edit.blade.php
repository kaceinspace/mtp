...
<div class="max-w-4xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Edit Project Information</h2>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Update the project details</p>
        </div>
        ...
        <form action="{{ route('projects.update', $project) }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="description"
                          ...
                          placeholder="Describe the project goals and objectives">{{ old('description', $project->description) }}</textarea>
                @error('description')
                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
                ...
                <div>
                    ...
                    <select name="team"
                        ...
                        @foreach($teams as $team)
                            <option value="{{ $team->id }}" {{ old('team', $project->team) == $team->id ? 'selected' : '' }}>
                                {{ $team->name }}
                            </option>
                        @endforeach
                    </select>
