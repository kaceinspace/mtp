...
<div class="max-w-5xl mx-auto">
    <form action="{{ route('admin.users.store') }}" method="POST" class="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden backdrop-blur-sm">
        @csrf
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-8 py-6 border-b border-gray-200">
            <div class="flex items-center justify-between max-w-2xl mx-auto">
                <div class="flex items-center space-x-2">
                    <div class="w-10 h-10 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white flex items-center justify-center font-bold shadow-lg">1</div>
                    <span class="text-sm font-semibold text-gray-700">Pilih Tipe</span>
                </div>
                <div class="flex-1 h-1 bg-gradient-to-r from-blue-600 to-indigo-600 mx-4"></div>
                <div class="flex items-center space-x-2">
                    <div class="w-10 h-10 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white flex items-center justify-center font-bold shadow-lg">2</div>
                    <span class="text-sm font-semibold text-gray-700">Isi Data</span>
                </div>
                <div class="flex-1 h-1 bg-gradient-to-r from-blue-600 to-indigo-600 mx-4"></div>
                <div class="flex items-center space-x-2">
                    <div class="w-10 h-10 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white flex items-center justify-center font-bold shadow-lg">3</div>
                    <span class="text-sm font-semibold text-gray-700">Simpan</span>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 space-y-8">
            ...
            <div>
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-4">
                        <label class="block text-lg font-bold text-gray-900">Pilih Tipe User <span class="text-red-500">*</span></label>
                        <p class="text-sm text-gray-500">Tentukan peran user dalam sistem</p>
                    </div>
                </div>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <label class="group relative flex flex-col items-center justify-center p-6 border-3 border-gray-300 rounded-2xl cursor-pointer hover:border-purple-500 hover:shadow-xl hover:shadow-purple-500/30 hover:-translate-y-1 transition-all duration-300 {{ old('user_type') == 'admin' ? 'border-purple-500 bg-gradient-to-br from-purple-50 to-purple-100 shadow-xl shadow-purple-500/30' : '' }}">
            ...
            <div>
                <div class="flex items-center mb-6">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">Data pribadi user</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="group">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required placeholder="user@smkassalaam.sch.id"
        ...
        <!-- Footer -->
        <div class="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-6 border-t-2 border-gray-200 flex items-center justify-end space-x-4">
            ...
            <button type="submit" class="group px-8 py-3 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 text-white rounded-xl hover:shadow-2xl hover:shadow-blue-500/50 hover:-translate-y-0.5 transition-all duration-300 font-bold inline-flex items-center space-x-2">
