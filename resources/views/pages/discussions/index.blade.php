...
@section('title', 'Discussion - ' . $project->title)
...
<div class="container mx-auto px-4 py-6" x-data="discussionBoard()">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-2">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Team Discussion</h1>
    ...
    <div id="new-messages-banner" class="hidden bg-blue-500 text-white rounded-lg shadow-lg p-4 mb-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <span><span class="message-count font-semibold">0</span> new message(s)</span>
        </div>
    ...
    <div id="discussions-container" class="space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">No discussions yet</h3>
            <p class="text-gray-600 dark:text-gray-400">Be the first to start a conversation!</p>
        </div>
        @endforelse
    </div>
