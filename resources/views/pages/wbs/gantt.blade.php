...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                <i class="fas fa-chart-gantt mr-2"></i>Gantt Chart View
            </h1>
    ...
    <div class="mb-4">
        <label class="inline-flex items-center cursor-pointer">
            ...
            <span class="ml-2 text-gray-700 dark:text-gray-300">Highlight Critical Path</span>
        </label>
    </div>
    ...
    <div class="mt-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4">
        <h3 class="font-bold text-gray-900 dark:text-white mb-2">Legend:</h3>
        <div class="flex gap-4 flex-wrap">
            <div class="flex items-center">
                <div class="w-4 h-4 bg-blue-500 rounded mr-2"></div>
                <span class="text-sm text-gray-700 dark:text-gray-300">Regular Task</span>
            </div>
            <div class="flex items-center">
                <div class="w-4 h-4 bg-red-500 rounded mr-2"></div>
                <span class="text-sm text-gray-700 dark:text-gray-300">Critical Path</span>
            </div>
            <div class="flex items-center">
